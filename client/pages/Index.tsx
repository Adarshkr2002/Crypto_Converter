  ...
  return (
    ...
    >
      <nav className="container mx-auto px-6 flex items-center justify-between">
        <div className="text-2xl font-bold gradient-text">Adarsh Kumar Jha</div>
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
            Real-time cryptocurrency prices in Indian Rupees with advanced
            calculator tools
          </p>
          <button
...
const CryptoCard = ({ crypto }: { crypto: (typeof cryptoData)[0] }) => (
  <div className="glass-card p-6 hover:scale-105 transition-all duration-500 group cursor-pointer">
    <div className="flex items-center justify-between mb-4">
      ...
      <div
        className={`text-sm font-medium ${crypto.change.startsWith("+") ? "text-green-400" : "text-red-400"}`}
      >
        {crypto.change}
      </div>
    </div>
...
const Calculator = () => {
  ...
  const calculateConversion = () => {
    ...
    if (calculationType === "crypto-to-inr") {
      ...
      const result =
        parseFloat(inrAmount.replace(/,/g, "") || "0") / crypto.price;
  ...
  <section id="about" className="py-20 px-6">
    <div className="container mx-auto max-w-4xl text-center">
      ...
      <p className="text-xl text-gray-300 leading-relaxed mb-8">
        This cryptocurrency price tracker and calculator provides real-time INR
        prices for popular cryptocurrencies. Built for educational and demo
        purposes, it features a modern Web3-inspired design with glassmorphism
        effects and smooth animations. Perfect for tracking crypto investments
